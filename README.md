...
* `CustomNoMADLocation` String to define the location of a custom NoMAD installation location to support automatic ACL declaration when `KeychainAdd` is utilized, default is `/Applications/NoMAD.app`
